                ...
                fluidRow(
                    box(width=12,
                        ...
                        "Based on an N-Gram Language Model, the prediction algorithm developed provides fitting suggestions to allow for words and thoughts going forward.",              tags$br(), tags$br(),  
                           "The source code along with further information on the project can be found here:", tags$a("Source Code", href= "https://github.com/Kazishadidraiyan/Data-Science-Capstone"), style = "font-size: 125%"))))
    ))
)
